...
int main()
{
    ...
    do
    {
        ...
        {
            int cod;
            cout << "\nIngrese el código del material a buscar: ";
            cin >> cod;
            buscar_material(cod);
            break;
        }
        case 5:
        {
            ...
            cout << "\nIngrese el código del material antes del cual desea insertar: ";
            cin >> cod;
            cout << "\nIngrese el código del nuevo material: ";
            cin >> codNuevo;
        ...
        {
            int cod;
            cout << "\nIngrese el código del material a editar: ";
            cin >> cod;
            editar_material(cod);
            break;
        }
        ...
        {
            int cod;
            cout << "\nIngrese el código del material a borrar: ";
            cin >> cod;
            borrar_material(cod);
            break;
        }
